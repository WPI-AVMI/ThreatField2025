...
#include "interface/msg/detail/sensor__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const interface::msg::Sensor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  interface::msg::Sensor & ros_message)
{
  // Member: dx
  cdr >> ros_message.dx;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = interface::msg::Sensor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const interface::msg::Sensor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface::msg::Sensor *>(
    untyped_ros_message);
...
{
  return &interface::msg::typesupport_fastrtps_cpp::_Sensor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interface, msg, Sensor)() {
  return &interface::msg::typesupport_fastrtps_cpp::_Sensor__handle;
}
